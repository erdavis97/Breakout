...
//  Breakout
//
//  Created by Ethan Davis on 3/18/24.
//
...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    func makeBall() {
        ...
        addChild(ball) //adds ball object to view
    }
    ...
    //figure the number and spacing of each row of bricks
    ...
    override func update(_ currentTime: TimeInterval) {
        ...
        if abs(ball.physicsBody!.velocity.dy) < 100 {
            //ball has stalled in y direfction so kick it randomly vertically
